angular.module("SigninApp").directive("facebookLoginButton", function (AuthService) {
    return {
        restrict: 'A',
...
angular.module("SigninApp").factory("AuthService", function ($http, $sanitize, $location, SessionService) {
